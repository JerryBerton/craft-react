...
```bash
yarn add @bertonjs/craft-core
```

or with npm:
```bash
npm install --save @bertonjs/craft-core
```
...
```jsx {2,7,10,11,13}
// components/user/Card.js
import {useNode, Element} from "@bertonjs/craft-core";
...
import Text from "./Text";
import Button from "./Button";
import { Element, useNode } from "@bertonjs/craft-core";
...
import React from "react";
import { Box, Typography, Grid, Button as MaterialButton } from "@material-ui/core";
import { Element, useEditor } from "@bertonjs/craft-core";
